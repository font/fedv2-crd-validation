...
package federateddeployment_test

import (
	"testing"

	"github.com/font/fedv2-crd-validation/pkg/client/clientset/versioned"
	"github.com/font/fedv2-crd-validation/pkg/inject"
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedDeployment Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("FederatedDeploymentController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedDeploymentController")
})
