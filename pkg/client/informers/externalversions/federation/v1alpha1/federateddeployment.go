...
import (
	...
	federation_v1alpha1 "github.com/font/fedv2-crd-validation/pkg/apis/federation/v1alpha1"
	versioned "github.com/font/fedv2-crd-validation/pkg/client/clientset/versioned"
	internalinterfaces "github.com/font/fedv2-crd-validation/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/font/fedv2-crd-validation/pkg/client/listers/federation/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FederationV1alpha1().FederatedDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FederationV1alpha1().FederatedDeployments(namespace).Watch(options)
			},
		},
		&federation_v1alpha1.FederatedDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *federatedDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&federation_v1alpha1.FederatedDeployment{}, f.defaultInformer)
}

func (f *federatedDeploymentInformer) Lister() v1alpha1.FederatedDeploymentLister {
	return v1alpha1.NewFederatedDeploymentLister(f.Informer().GetIndexer())
}
